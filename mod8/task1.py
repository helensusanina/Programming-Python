class Transport:
    ...
    def isInArea(self, pos_x, pos_y, length, width) -> bool:
        """
        Присутствие транспортного средства в пределах заданноой области
...
class Bus(Auto, Passenger):
    ...
    def bus_boarding(self):
        if self.number_of_passengers > self.passengers_capacity:
            print("Места закончились. Пассажиров без места: "
                  + self.passengers_capacity - self.number_of_passengers)
        else:
            self.passengers_capacity -= self.number_of_passengers
            print("Посадка окончена. Места осталось: " + self.passengers_capacity - self.number_of_passengers)
...
class CargoAuto(Auto, Cargo):
    ...
    def load_car(self):
        if self.carrying > self._cargo:
            ...
            print("загрузка выполнилась успешно")
        else:
            self.carrying -= self._cargo
            print("объем груза больше, чем вместимость в машины, поэтому места осталось" + self.carrying - self._cargo)
...
class Boat(Ship):
    ...
    def fill_fuel(self):
        ...
        if self._fuel + 10 > 100:
            ...
            print("Бак заполнен, остатки вылились ")
...
class PassengerShip(Ship, Passenger):
    ...
    def take_passenger(self):
        if self.passengers_capacity < self.number_of_passengers:
            print("борт-полон, места осталось: " + self.passengers_capacity - self.number_of_passengers + "людей")
            self.passengers_capacity -= self.number_of_passengers
        else:
            self.passengers_capacity -= self.number_of_passengers
            print("Посадка закончилась")
...
class CargoShip(Ship, Cargo):
    ...
    def load_ship(self):
        if self.carrying > self._cargo:
            ...
            self.carrying -= self._cargo
            print("объем груза больше, чем вместимость корабля, поэтому места осталось" + self.carrying - self._cargo)
...
class PassengerPlane(Plane, Passenger):
    ...
    def plane_boarding(self):
        if self.number_of_passengers > self.passengers_capacity:
            ...
            self.passengers_capacity -= self.number_of_passengers
            print("Посадка выполнилась успешно. Места осталось: " + self.passengers_capacity - self.number_of_passengers)
            self.passengers_capacity -= self.number_of_passengers
...
class CargoPlane(Plane, Cargo):
    ...
    def load_plane(self):
        if self.carrying > self._cargo:
            ...
            self.carrying -= self._cargo
            print("объем груза больше, чем вместимость самолета, поэтому места осталось" + self.carrying - self._cargo)
